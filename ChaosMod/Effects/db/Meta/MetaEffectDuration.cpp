...
{
	MetaModifiers::m_fEffectDurationModifier = 0.5 / MetaModifiers::m_fChaosMultiplier;
}
...
{
	MetaModifiers::m_fEffectDurationModifier = 2 * MetaModifiers::m_fChaosMultiplier;
}
