...
static RegisterEffect registerEffect1(EFFECT_GAMESPEED_X02, nullptr, OnStop, OnTickX02, EffectInfo
	{
		...
		.IncompatibleWith = { EFFECT_HIGH_PITCH, EFFECT_GAMESPEED_X05, EFFECT_LOW_PITCH, EFFECT_MISC_SIN_PITCH, EFFECT_WEIRD_PITCH, EFFECT_PEDS_MINIONS, EFFECT_PLAYER_DEAD_EYE }
	}
);
...
static RegisterEffect registerEffect2(EFFECT_GAMESPEED_X05, nullptr, OnStop, OnTickX05, EffectInfo
	{
		...
		.IsTimed = true,
		.IsShortDuration = true,
		.IncompatibleWith = { EFFECT_GAMESPEED_X02, EFFECT_HIGH_PITCH, EFFECT_LOW_PITCH, EFFECT_MISC_SIN_PITCH, EFFECT_WEIRD_PITCH, EFFECT_PEDS_MINIONS, EFFECT_PLAYER_DEAD_EYE }
	}
);