...
static void OnTickX02()
{
	...
	Hooks::SetAudioPitch(-900 * MetaModifiers::m_fChaosMultiplier);

	SET_TIME_SCALE(.2f / MetaModifiers::m_fChaosMultiplier);
}
...
static void OnTickX05()
{
	...
	Hooks::SetAudioPitch(-500 * MetaModifiers::m_fChaosMultiplier);

	SET_TIME_SCALE(.5f / MetaModifiers::m_fChaosMultiplier);
}
