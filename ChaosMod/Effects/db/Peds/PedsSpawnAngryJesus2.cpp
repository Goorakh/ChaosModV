...
static void OnStart()
{
	...
	{
		// Offset x for every new instance spawned, to avoid them spawning inside one another
		Vehicle veh = CreatePoolVehicle(oppressorHash, playerPos.x + (i * 2), playerPos.y, playerPos.z + i, heading);
