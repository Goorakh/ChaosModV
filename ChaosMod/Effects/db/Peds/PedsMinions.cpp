...
static void OnTick()
{
	Hooks::SetAudioPitch(300 * g_MetaInfo.m_fChaosMultiplier);
...
static RegisterEffect registerEffect(EFFECT_PEDS_MINIONS, nullptr, OnStop, OnTick, EffectInfo
	{
		...
		.Id = "peds_minions",
		.IsTimed = true,
		.IncompatibleWith = { EFFECT_HIGH_PITCH, EFFECT_LOW_PITCH, EFFECT_WEIRD_PITCH, EFFECT_GAMESPEED_X02, EFFECT_GAMESPEED_X05, EFFECT_MISC_SIN_PITCH, EFFECT_PEDS_HEADLESS }
	}
);