...
static void OnTick()
{
	...
	float shook = GET_RANDOM_FLOAT_IN_RANGE(-9.f, 7.f) * g_MetaInfo.m_fChaosMultiplier; // low slightly lower than oppisite of upper to decrease chances of stuff going into space.
