...
static void OnTick()
{
    ...
    if (orbitingPeds.size() != pedCount * MetaModifiers::m_fChaosMultiplier)
    {
        int pedsDiff = (pedCount * MetaModifiers::m_fChaosMultiplier) - orbitingPeds.size();
        ...
        {
            float offset = (360 / (pedCount * MetaModifiers::m_fChaosMultiplier)) * i;
