...
static void OnTick()
{
	Hooks::SetAudioPitch(ms_fTargetPitch * g_MetaInfo.m_fChaosMultiplier);
}
...
static RegisterEffect registerEffect(EFFECT_LOW_PITCH, OnStart, OnStop, OnTick, EffectInfo
	{
		...
		.Id = "misc_lowpitch",
		.IsTimed = true,
		.IncompatibleWith = { EFFECT_HIGH_PITCH, EFFECT_WEIRD_PITCH, EFFECT_PEDS_MINIONS, EFFECT_GAMESPEED_X02, EFFECT_GAMESPEED_X05, EFFECT_MISC_SIN_PITCH }
	}
);