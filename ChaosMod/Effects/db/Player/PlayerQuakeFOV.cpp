...
static RegisterEffect registerEffect(EFFECT_PLAYER_QUAKE_FOV, OnStart, OnStop, OnTick, EffectInfo
	{
		...
		.Id = "player_quake_fov",
		.IsTimed = true,
		.IncompatibleWith = { EFFECT_FLIP_CAMERA, EFFECT_PLAYER_GTA_2, EFFECT_PLAYER_BINOCULARS, EFFECT_PLAYER_ZOOMZOOM_CAM, EFFECT_PLAYER_SICK_CAM, EFFECT_LEANED_CAMERA }
	}
);