...
static void UpdateCamera()
{
    ...
    CAM::SET_CAM_PARAMS(fovCamera, coord.x, coord.y, coord.z, rot.x, rot.y, rot.z, 120.f + approach(10.f), 0, 1, 1, 2);
}
...
static RegisterEffect registerEffect(EFFECT_PLAYER_QUAKE_FOV, OnStart, OnStop, OnTick, EffectInfo
	{
		...
		.Id = "player_quake_fov",
		.IsTimed = true,
		.IncompatibleWith = { EFFECT_MISC_NEWS_TEAM, EFFECT_PLAYER_BINOCULARS, EFFECT_FLIP_CAMERA, EFFECT_PLAYER_GTA_2, EFFECT_PLAYER_SPIN_CAMERA, EFFECT_PLAYER_ZOOMZOOM_CAM, EFFECT_LEANED_CAMERA, EFFECT_PLAYER_SICK_CAM }
	}
);