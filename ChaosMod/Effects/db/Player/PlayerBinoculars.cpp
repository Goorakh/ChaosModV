...
#include <stdafx.h>
#include "Memory/Hooks/CamRenderHook.h"
...
static void OnTick()
{
    Hooks::SetForceRenderFieldOfView(10.f);
}

static RegisterEffect registerEffect(EFFECT_PLAYER_BINOCULARS, nullptr, nullptr, OnTick, EffectInfo
    {
        .Name = "Binoculars",
