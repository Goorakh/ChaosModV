...
{
    if (match > CHANCE / MetaModifiers::m_fChaosMultiplier)
    {
        match = g_Random.GetRandomInt(0, CHANCE / MetaModifiers::m_fChaosMultiplier);
    }
}
...
static void OnTick() {
    ...
    UpdateRand();
    int rand_int = g_Random.GetRandomInt(0, CHANCE / MetaModifiers::m_fChaosMultiplier);
