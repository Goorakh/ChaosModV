...
{
	Ped playerPed = PLAYER_PED_ID();
	Vector3 newPos = GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(playerPed, 0.f, 50.f * MetaModifiers::m_fChaosMultiplier, 0.f);
	float groundZ;
...
static void OnStartFakeTp()
{
	...
	WAIT(g_Random.GetRandomInt(3500, 6000) * MetaModifiers::m_fChaosMultiplier);
