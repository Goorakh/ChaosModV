...
static void OnStart()
{
	...
	if (IS_PED_IN_ANY_VEHICLE(playerPed, false))
	{
		...
		SET_ENTITY_VELOCITY(playerVeh, playerVel.x, playerVel.y, 100.f * MetaModifiers::m_fChaosMultiplier);
	}
	else
	{
		...
		SET_ENTITY_VELOCITY(playerPed, playerVel.x, playerVel.y, 100.f * MetaModifiers::m_fChaosMultiplier);
	}
}
