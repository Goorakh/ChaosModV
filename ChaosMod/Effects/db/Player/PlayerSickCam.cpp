...
static void UpdateCamera()
{
    ...
    SET_CAM_PARAMS(sickCamera, coord.x, coord.y, coord.z, camRotX * (50 - abs(camRotX)) / 50, camRotY * (70 - abs(camRotY)) / 70, rot.z,80 - (camZoom - 80) * (40 - abs(80 - camZoom)) / 40, 0, 1, 1, 2);
}
...
static RegisterEffect registerEffect(EFFECT_PLAYER_SICK_CAM, OnStart, OnStop, OnTick, EffectInfo
    {
        .Name = "I Feel Sick",
        .Id = "player_sick_cam",
        .IsTimed = true,
